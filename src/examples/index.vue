...
>
    <CustomOverlay
        ...
        :render-level="12"
    >
        <div style="background: darkgreen;padding: 10px;border: 1px solid yellow;">custom overlay</div>
    </CustomOverlay>

    <Polyline :points="_path" @click="log"></Polyline>

    <Circle
        center="116.08405648702066,39.50625062759024"
        :radius="5000"
        @click="log"
    ></Circle>
    ...
    <NavigationControl3D :anchor="1" :offset="10"></NavigationControl3D>
...
import { Map, ZoomControl, CustomOverlay, Polyline, Circle, NavigationControl3D, ScaleControl } from '../components'
...
onMounted(() => {
    ...
    console.log('parent get map', mapComp.value?.map)
})
</script>

<style>
.bmapgl-navigation-control-3d>div, .bmapgl-navigation-control-3d button{
    background-image: url('./assets/gl-navi-control-pc4.png')!important;
}
.bmapgl-navigation-control-3d>button, .BMap_stdMpZoom .BMap_button_new{
